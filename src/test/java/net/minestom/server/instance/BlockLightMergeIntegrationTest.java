...
public class BlockLightMergeIntegrationTest {
    ...
    public void skylightShortGrass(Env env) {
        ...
        byte val = lightValSky(instance, new BlockVec(94, 50, 128));
        assertEquals(15, val);
    }
    ...
    public void skylightContained(Env env) {
        ...
        byte val = lightValSky(instance, new BlockVec(94, 51, 128));
        byte val2 = lightValSky(instance, new BlockVec(94, 52, 128));
        assertEquals(0, val2);
        assertEquals(0, val);
    }
