...
//                            short experienceCount = pickupExperienceEvent.getExperienceCount(); // TODO give to player
    ...
    public void respawn() {
        ...
        // TODO should likely not .join() and return a future
        teleport(respawnPosition).thenRun(chunkTracker::finishRespawn).thenRun(this::refreshAfterTeleport).join();
    }
    ...
    private void spawnPlayer(Instance instance, Pos spawnPosition,
        ...
        // TODO should likely not join and instead use an assertion?
    ...
    private void updateViewDistance(int oldSettingsViewDistance, int oldInstanceViewDistance, int newInstanceViewDistance) {
        ...
        if (instance != null) {
            // changing position also updates a modified view distance. May want a better name in the future
    ...
    @Override
    public CompletableFuture<Void> teleport(Pos position, Vec velocity, int flags, boolean shouldConfirm) {
        chunkUpdateLimitChecker.clearHistory();
